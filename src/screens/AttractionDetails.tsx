...
import { RootStackParamList } from './Attractions';

type AttractionNavigationProp = StackNavigationProp<RootStackParamList, 'AttractionDetails'>;
...
const Attraction: React.FC<AttractionProps> = ({ navigation, route }) => {
            ...
            >
                <View style={styles.container}>
                    <View style={styles.header}>
                        <TouchableOpacity style={styles.iconButton} onPress={() => navigation.navigate('Attraction')}>
